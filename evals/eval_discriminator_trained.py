...
# get paths
trained_checkpt_path = "discriminator_step_100"
...
trained_model = GenericLLM(raw_model, tokenizer, "trained", DISCRIMINATOR_SYSTEM_PROMPT)
...
for problem in problems:
    ...
    if not isinstance(total_tests, int):
        ...
        with open('trained_disc.csv', 'a', newline='') as csvfile:
